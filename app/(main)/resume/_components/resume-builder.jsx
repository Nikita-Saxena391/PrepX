...
<div className="relative mb-6 px-6 md:px-10 lg:px-20 pt-24 flex items-center">
  ...
  <p className="text-lg font-medium text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-200">
  Create your custom AI-powered resume
</p>
